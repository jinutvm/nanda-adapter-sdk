...
class NANDA {
    constructor(improvementLogic, options = {}) {
        ...
        this.agentId = options.agentId; // Don't generate default, let NANDA core handle it
    ...
    async startServerAPI(config) {
        ...
        try {
            ...
            const serverConfig = {
                ...
                agent_id: config.agentId || this.agentId || undefined, // Let NANDA core generate if not specified
